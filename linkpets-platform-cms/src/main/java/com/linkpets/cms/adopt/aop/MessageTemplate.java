...
public class MessageTemplate {
    ...
    public static final String PET_MSG_TITLE = "您已成功创建一条宠物领养信息，请耐心等待系统审核";

    public static final String PET_MSG_CONTENT_TITLE = " 宠物领养信息创建成功";
    ...
    public static final String APPLY_MSG_CONTENT_TITLE = " 发来一个领养申请";

    public static final String APPLY_MSG_CONTENT_LOG = "请到【我收到的领养申请】查看详情";


    public static final String APPLY_PASS_FIRST_MSG_TITLE = "恭喜，您对 # 的领养申请已通过初审";

    public static final String APPLY_PASS_FIRST_MSG_CONTENT_TITLE = " 领养申请通过初审，等待送养方终审";
    ...
    public static final String APPLY_PASS_FORTH_MSG_CONTENT_TITLE = "恭喜您成功领养,快去线下接回你的新主子吧!";

    public static final String APPLY_PASS_FORTH_MSG_CONTENT_LOG = "协议内容已具备法律效应,身份信息已经备案,请双方遵守协议内容,以免承担相应的法律责任";


    public static final String APPLY_PASS_FORTH_ADOPTER_MSG_TITLE = "恭喜您,成功送养一只流浪孩子!";
    ...
    public static final String APPLY_REFUSE_MSG_CONTENT_TITLE = "领养申请已取消";

    public static final String APPLY_REFUSE_MSG_CONTENT_LOG = "原因：";


    /**
     * 用户上传实名认证
     */
    public static final String CER_MSG_TITLE = "您已成功上传身份信息，请耐心等待系统审核";

    public static final String CER_MSG_CONTENT_TITLE = " 实名认证信息上传成功，等待审核";

    public static final String CER_MSG_CONTENT_LOG = "平台将会在1-3个工作日审核完毕";


    public static final String CER_PASS_MSG_TITLE = "恭喜您，实名认证成功";
    ...
    public static final String CER_REJECT_MSG_CONTENT_TITLE = "实名认证及身份信息审核未通过";
