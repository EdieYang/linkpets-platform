...
public class PointStatementAspect {
     ...
     * 每日签到获取积分
     */
    @Pointcut("execution(public * com.linkpets.cms.adopt.service.ISignInService.crtSignInRecord(..))")
    ...
    public void aroundCrtCertificationPointCut(ProceedingJoinPoint pjp) {
        ...
        try {
            ...
            List<CmsAdoptPointsStatement> pointStatmentList = pointStatementService.getPointStatementListByChannel(userId, PointsChannelEnum.COMPLETE_USER_INFO.getChannel());
