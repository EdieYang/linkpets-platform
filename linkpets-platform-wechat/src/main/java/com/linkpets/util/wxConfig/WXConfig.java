package com.linkpets.util.wxConfig;

public class WXConfig {

    public static String appid = "wxb9bbcce54562d172";
    
    public static String appsecret = "0ba7e2675590fd5dbd6be661ecf21547";
    ...
    public static String redirect_uri = "http://sdfsdfsdf";//自己的授权地址
