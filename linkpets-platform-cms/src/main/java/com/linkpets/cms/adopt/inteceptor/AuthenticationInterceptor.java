package com.linkpets.cms.adopt.inteceptor;
...
import com.linkpets.annotation.PassToken;
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object object) throws Exception {
        ...
        if (method.isAnnotationPresent(UserLoginToken.class) || method.getDeclaringClass().isAnnotationPresent(UserLoginToken.class)) {
            ...
            if (userLoginToken.required()) {
                // 执行认证
                if (token == null) {
                    throw new RuntimeException(String.valueOf(ResultCode.VALID_USER_LOGIN_TOKEN.getCode()));
                }
                // 获取 token 中的 user id
                String userId;
                try {
                ...
                if (user == null) {
                    throw new RuntimeException(String.valueOf(ResultCode.VALID_USER_ACCOUNT.getCode()));
                }
                // 验证 token
